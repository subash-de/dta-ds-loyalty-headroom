...
# MAGIC - skipping this step and use the version for 2023 04 24 
...
# all_data = trx_manager.get(trx_line_df, articles_df, cust_seg=segmentations_tbl.filter(F.col("cust_id") == "6872732896086312431"))
...
# MAGIC %sql select * from loyalty_azlab_prod.headroom_etl_data_p_tbl where campaign = 20230421
...
# MAGIC %sql select * from loyalty_azlab_prod.headroom_etl_data_p_tbl where campaign = 20230424
...
if "predict" in config.steps:
    ...
    for seg in seg_list:
        ...
        predictions = (predictions.withColumn("campaign", F.lit("20230426")))
