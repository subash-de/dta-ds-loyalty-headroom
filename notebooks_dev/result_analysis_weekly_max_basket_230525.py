...
# MAGIC %sql select campaign, count (distinct campaign) from loyalty_azlab_prod.headroom_allocation_p_tbl group by campaign  
...
# alloc.write.parquet("/mnt/centralds/offerallocation/headroom/analysis/230525/allocation", mode = "overwrite")
...
alloc = spark.read.parquet("/mnt/centralds/offerallocation/headroom/analysis/230525/allocation")
alloc.count()
