...
# MAGIC %sql select * from loyalty_azlab_prod.headroom_allocation_p_tbl where campaign = 20230424 and cust_id = '6872732896086312431'

# COMMAND ----------

# MAGIC %sql select * from loyalty_azlab_prod.headroom_allocation_p_tbl where campaign = 20230424 and cust_id = '-7385606211536121860'
