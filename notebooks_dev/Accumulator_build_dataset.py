...
config_use = config["use_segments"]
config_use.segmentations_tbl.partitionByList

# COMMAND ----------

get_date(config_bd["etl_date"])
...
type(get_date(config_bd["etl_date"]))
...
trx_manager.etl_date, trx_manager.lookback_date
...
display(percentile_spend_time_window)
...
display(customer_lx_time_window_spend)
...
display(customer_lx_basket_spend)
...
display(customer_lx_basket_spend_temp)
